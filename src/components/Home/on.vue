<template>
  <div class="work-card">
    ...
    <p>
      ...
      <g-link to="http://bit.ly/2vxQka1" target="_blank"> More Info</g-link>
      ...
      <g-link to="http://bit.ly/2TdCCSA" target="_blank"> More Info</g-link>
      <br />
      <!--Valentines Mansion-->
      ...
      <g-link to="http://bit.ly/2TtpXtv" target="_blank"> More Info</g-link>

      <br />
    </p>
    <g-link to="/visit">Places to visit</g-link>
  </div>
</template>
