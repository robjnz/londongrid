<template>
<b-card bg-variant="dark" text-variant="white" title= "Band Vaaje 12A">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/0FZ8Cha8uys"
          allowfullscreen
  ></b-embed>
...
import BandR from '@/components/ReviewMovies/BandR'
