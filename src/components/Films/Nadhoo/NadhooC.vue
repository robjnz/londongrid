<template>
<b-card bg-variant="dark" text-variant="white" title= "Nadhoo Khan PG ">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/Vx8svo-577c"
          allowfullscreen
  ></b-embed>
    <p class="title-color">
      A man tries to heed his grandfather's advice to stay away from women while pursuing his dream of becoming a wrestler.
    </p>
