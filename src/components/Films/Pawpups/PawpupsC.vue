<template>
<b-card bg-variant="dark" text-variant="white" title= "Paw Patrol Mighty Pups U">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/VpUdNHEHmbc"
          allowfullscreen
  ></b-embed>
    <p class="title-color">
    </p>
...
import PawpupsR from '@/components/Films/Pawpups/PawpupsR'
