<template>
<b-card bg-variant="dark" text-variant="white" title= "The Hustle 12A ">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/fhkNMqy4AGw"
          allowfullscreen
  ></b-embed>
    <p class="title-color">
Anne Hathaway and Rebel Wilson star as female scam artists, one low rent and the other high class, who team up to take down the dirty rotten men who have wronged them.    </p>
...
import HustleR from '@/components/Films/Hustle/HustleR'
