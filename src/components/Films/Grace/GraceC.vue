<template>
<b-card bg-variant="dark" text-variant="white" title= "Amazing Grace U ">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/gkKOIQwTiKE"
          allowfullscreen
  ></b-embed>
    <p class="title-color">
      Aretha Franklin performs gospel songs at the New Temple Missionary Baptist Church in Los Angeles in 1972.
    </p>
...
import GraceR from '@/components/Films/Grace/GraceR'
