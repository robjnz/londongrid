<template>
<b-card bg-variant="dark" text-variant="white" title= "Border 15">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/QMs28A1s1OA"
          allowfullscreen
  ></b-embed>
...
import BorderR from '@/components/ReviewMovies/BorderR'
