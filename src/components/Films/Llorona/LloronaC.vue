...
<b-embed type="iframe"
  ...
  ></b-embed>
    <p class="title-color">
    The legendary ghost La Llorona is stalking the night. </p>
...
import LloronaR from '@/components/Films/Llorona/LloronaR'
import LloronaF from '@/components/Films/Llorona/LloronaF'
