<template>
<b-card bg-variant="dark" text-variant="white" title= "The sisters Brother 12A">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/H9d310frjNk"
          allowfullscreen
  ></b-embed>

  <p class="title-color">
It's 1851, and Charlie and Eli Sisters are both brothers and assassins, boys grown to men in a savage and hostile world.
</p>
...
import SisterR from '@/components/Films/Sister/SisterR'
import SisterF from '@/components/Films/Sister/SisterF'
