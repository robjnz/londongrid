<template>
<b-card bg-variant="dark" text-variant="white" title= "Rabb Da Radio 2 PG">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/_GRj61OrGHs"
          allowfullscreen
  ></b-embed>
...
import RabbR from '@/components/ReviewMovies/RabbR'
