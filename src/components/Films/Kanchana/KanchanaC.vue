<template>
<b-card bg-variant="dark" text-variant="white" title= "Kanchana 3 15">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/-16MdQ9Blgk"
          allowfullscreen
  ></b-embed>
    <p class="title-color">
...
import KanchanaR from '@/components/Films/Kanchana/KanchanaR'
import KanchanaF from '@/components/Films/Kanchana/KanchanaF'
