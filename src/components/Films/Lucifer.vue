<template>
<b-card bg-variant="dark" text-variant="white" title= "Lucifer 12A">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/x1-Ya0NZQso"
          allowfullscreen
  ></b-embed>
...
import LuciferR from '@/components/ReviewMovies/LuciferR'
