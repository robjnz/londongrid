<template>
<b-card bg-variant="dark" text-variant="white" title= "Junglee PG">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/tcsJ-3GLDE4"
          allowfullscreen
  ></b-embed>
...
import JungleeR from '@/components/ReviewMovies/JungleeR'
