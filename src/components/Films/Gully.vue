<template>
<b-card bg-variant="dark" text-variant="white" title= "Gully Boy 15">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/JfbxcD6biOk"
          allowfullscreen
  ></b-embed>
...
import GullyR from '@/components/ReviewMovies/GullyR'
