<template>
<b-card bg-variant="dark" text-variant="white" title= "Hellboy 15">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/dt5g5_1cKVk"
          allowfullscreen
  ></b-embed>
    <p class="title-color">
...
import HellboyR from '@/components/Films/Hellboy/HellboyR'
import HellboyF from '@/components/Films/Hellboy/HellboyF'
