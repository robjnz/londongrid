<template>
<b-card bg-variant="dark" text-variant="white" title= "Lords of Chaos 18">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/rnNJmLw3eIY"
          allowfullscreen
  ></b-embed>
...
import LordsR from '@/components/ReviewMovies/LordsR'
