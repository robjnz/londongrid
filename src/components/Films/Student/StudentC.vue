<template>
<b-card bg-variant="dark" text-variant="white" title= "Student of the year 2 12A ">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/QZsthdsh6yk"
          allowfullscreen
  ></b-embed>
    <p class="title-color">
...
import StudentR from '@/components/Films/Student/StudentR'
