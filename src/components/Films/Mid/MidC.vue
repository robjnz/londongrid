<template>
<b-card bg-variant="dark" text-variant="white" title= "Mid 90s 15">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/Igfhy3Q5CeI"
          allowfullscreen
  ></b-embed>
    <p class="title-color">
...
import MidR from '@/components/Films/Mid/MidR'
import MidF from '@/components/Films/Mid/MidF'
