<template>
<b-card bg-variant="dark" text-variant="white" title= "The Keeper 15">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/fn3gUlcF-9g"
          allowfullscreen
  ></b-embed>
<p class="title-color">
  Bert Trautmann was the goalkeeper for Manchester City Football Club in the 1956 FA Cup Final.
  </p>
...
import KeeperR from '@/components/Films/Keeper/KeeperR'
import KeeperF from '@/components/Films/Keeper/KeeperF'
