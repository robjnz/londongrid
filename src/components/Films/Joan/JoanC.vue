<template>
<b-card bg-variant="dark" text-variant="white" title= "Red Joan 12A">
<b-embed type="iframe"
          aspect = "16by9"
  ...
  ></b-embed>
    <p class="title-color">
      Joan Stanley places her under arrest, The charge: providing classified scientific information to the Soviet government
    </p>
