<template>
<b-card bg-variant="dark" text-variant="white" title= "Luka Chuppi 12A">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/-JLewvWBkCw"
          allowfullscreen
  ></b-embed>
...
import LukaR from '@/components/ReviewMovies/LukaR'
