<template>
<b-card bg-variant="dark" text-variant="white" title= "Five Feet Apart 12A">
<b-embed type="iframe"
          aspect = "16by9"
...
import FiveR from '@/components/Films/Five/FiveR'
import FiveF from '@/components/Films/Five/FiveF'
