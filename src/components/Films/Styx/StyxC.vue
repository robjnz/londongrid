<template>
<b-card bg-variant="dark" text-variant="white" title= "Styx 12A">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/IPHvMn8dwi8"
          allowfullscreen
  ></b-embed>
    <p class="title-color">
A doctor spends her annual vacation sailing from Gibraltar to the small island of Ascension in the Atlantic. she sees a damaged, overloaded boat full of refugees nearby she begins to organize, help.for them.    </p>
...
import StyxR from '@/components/Films/Styx/StyxR'
import StyxF from '@/components/Films/Styx/StyxF'
