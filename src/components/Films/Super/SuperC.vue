<template>
<b-card bg-variant="dark" text-variant="white" title= "Super Deluxe">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/3-Xq_Zz3nPA"
          allowfullscreen
  ></b-embed>
    <p class="title-color">
    An unfaithful wife, an estranged father and an angry boy must all face their demons on one fateful day.</p>
