<template>
<b-card bg-variant="dark" text-variant="white" title= "Dil Diyan Gallan PG ">
<b-embed type="iframe"
          aspect = "16by9"
  ...
  ></b-embed>
    <p class="title-color">
      An internet sensation is invited to give a lecture on social media at a university during her trip to London.
      </p>
...
import GallanR from '@/components/Films/Gallan/GallanR'
