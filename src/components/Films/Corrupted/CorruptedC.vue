<template>
<b-card bg-variant="dark" text-variant="white" title= "The Corrupted 18 ">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/6lDcA_aGPh8"
          allowfullscreen
  ></b-embed>
    <p class="title-color">
Set ahead of the 2012 London Olympics, the film follows Liam, an ex-con trying to win back the love and trust of his family.
Liam's drive for redemption sees him caught up in a web of conspiracy, crime, and corruption.
</p>
...
import CorruptedR from '@/components/Films/Corrupted/CorruptedR'
