<template>
<b-card bg-variant="dark" text-variant="white" title= "Oru Yamandan Premakadha 12A">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/qV9de8pJCPw"
          allowfullscreen
  ></b-embed>
    <p class="title-color">
    When a young man confesses his desire to get married, his parents put pressure on their other son, a bachelor, to follow suit.
    </p>
