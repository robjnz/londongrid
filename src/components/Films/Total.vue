<template>
<b-card bg-variant="dark" text-variant="white" title= "Total Dhamal PG">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/fo9EhcwQXcM"
          allowfullscreen
  ></b-embed>
...
import TotalR from '@/components/ReviewMovies/TotalR'
