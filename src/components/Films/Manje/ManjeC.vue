<template>
<b-card bg-variant="dark" text-variant="white" title= "Manje Bistre 2 12A">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/BcLtt3oiMe8"
          allowfullscreen
  ></b-embed>
    <p class="title-color">
    Sukhi`s journey to Canada to attend his cousin`s marriage ceremony.
    </p>
...
import ManjeR from '@/components/Films/Manje/ManjeR'
