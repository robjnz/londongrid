<template>
<b-card bg-variant="dark" text-variant="white" title= "Eaten by Lion 12A ">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/45-9ygRHr0w"
          allowfullscreen
  ></b-embed>
...
import LionR from '@/components/ReviewMovies/LionR'
