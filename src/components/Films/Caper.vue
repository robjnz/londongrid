<template>
<b-card bg-variant="dark" text-variant="white" title= "Capernaum 15">
<b-embed type="iframe"
          aspect = "16by9"
          src    = "https://www.youtube.com/embed/wsCWP--3ZCg"
          allowfullscreen
  ></b-embed>
...
import CaperR from '@/components/ReviewMovies/CaperR'
