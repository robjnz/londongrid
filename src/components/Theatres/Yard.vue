<template>
  <b-card
    bg-variant   = "dark"
    text-variant = "white"
    title        = "Christopher Green - No Show"
    align        = "center"
  >
    <!-- 
...
-->
    <b-embed
      type   = "iframe"
      aspect = "16by9"
      src    = "https://www.youtube.com/embed/Cq0Zymj9Vfw"
      allowfullscreen
    ></b-embed>
    <p class="title-color">
      The Yard Hackney<br />
