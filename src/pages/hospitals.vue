                  ...
                  <div class="work-card">
                    <b-card-group deck class="mb-3">
                      ...
                      >
                        <p class="asian">
                          Homerton Row<br />
                          Hackney London E9 6SR
                          <br />

                          020 8510 5555
                        </p>
                        <b-button
                          href    = "http://bit.ly/2QXpoWR"
                          target  = "_blank"
                          variant = "info"
                          >open</b-button
                        >
                      ...
                      <b-card
                        bg-variant   = "dark"
                        text-variant = "white"
                        title        = "King George Hospital"
                        align        = "center"
                      >
                        <p class="asian">
                          Barley Lane<br />
                          Goodmayes Essex IG3 8YB
                          <br />
                          0330 400 4333
                        </p>
                        <b-button
                          href    = "http://bit.ly/2QTRgvc"
                          target  = "_blank"
                          variant = "info"
                          >open</b-button
                        >
...
export default {
  metaInfo: {
    title: "Hospital",
    meta : [{ name: "description", content: "East London Hospitals" }]
  }
};
</script>
